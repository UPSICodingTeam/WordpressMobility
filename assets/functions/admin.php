...
//Just testing Dashboard Widget
function hz_test_dashboard_widget() {
	
	?>
	<div id="dashboard-widgets-wrap">
	    <div id="dashboard-widgets" class="metabox-holder">
	        <div class="postbox-container" width="%">
	            <div id="normal-sortables" class="ui-sortable meta-box-sortable">
	                <!-- BOXES -->
	                <div class="postbox">...</div>
	            </div>
	        </div>
	        <div class="postbox-container" width="%">...</div>
	        <div class="postbox-container" width="%">...</div>
	        <div class="postbox-container" width="%">...</div>
	    </div>
	</div>
...
function joints_custom_dashboard_widgets() {
	wp_add_dashboard_widget('jhz_test_dashboard_widget', __('Mobility Unit Statistics', 'jointswp'), 'hz_test_dashboard_widget');
